...
// const (
// 	// Timeouts para el servidor HTTP
...
// // performGracefulShutdown realiza un cierre ordenado del servidor
...
// 		// Si el shutdown graceful falla, forzar cierre
...
// // startHealthMonitoring inicia monitoreo básico de salud (opcional)
...
// func logServerStats() {
// 	log.Printf("📊 Server Stats - Goroutines: %d", runtime.NumGoroutine())
// }
